...
export interface BaseUserResource<TEntity extends Entity> {
  listByUser: (params?: PaginationParams) => Promise<TEntity[]>
}

export interface BaseHasManyRelationshipResource<TManyEntity extends Entity> {
  listEntities: (
    id: string,
...
export interface BaseEntityUserResource<TId, TEntity extends BaseEntity<TId>> {
  listByUser: (params?: PaginationParams) => Promise<TEntity[]>
}
