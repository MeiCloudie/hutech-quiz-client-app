...
import { QuizBaseEntityResource } from "../../api/quizBaseResource"
import { PaginationParams } from "../models/paginationPrams"
import { toast } from "react-toastify"
// import { toastBasic } from "../configs"

export default class QuizBaseEntityStore<
  TId,
...
> {
  ...
  resource: QuizBaseEntityResource<TId, TEntity, TEntityFormValues>
  ...
  constructor(entityType: string) {
    ...
    this.resource = quizAgent.createEntityResource<TId, TEntity, TEntityFormValues>(entityType)
  }
