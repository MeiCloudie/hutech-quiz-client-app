...
import { QuizBaseResource } from "../../api/quizBaseResource"
// import { toastBasic } from "../configs"

export default class QuizEntityStore<
  TEntity extends Entity,
  TEntityFormValues extends EntityFormValues
> {
  _items: TEntity[] = []
  _selectedItem: TEntity | undefined = undefined
  resource: QuizBaseResource<TEntity, TEntityFormValues>
  ...
  constructor(entityType: string) {
    ...
    this.resource = quizAgent.createResource<TEntity, TEntityFormValues>(entityType)
  }
